...
(function (root) {
  ...
  function build(jsPDF, opts) {
    opts = opts || {};
    // Version tag for the PDF header — injected by the app (single source: version.js); no hardcoded version here.
    var BUILD = opts.version || (typeof APP_VERSION !== 'undefined' ? APP_VERSION : (root && root.APP_VERSION) || 'dev');
