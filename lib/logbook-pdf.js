...
(function (root) {
  ...
  function simCatEN(c) {
    ...
    return kr2latin(map[c] || c || 'Session');
  }
  ...
  function easaCols() {
    return [
      ...
      { lab: 'PIC NAME', w: 22, a: 'l', get: function (f) { return kr2latin(f.picName || ''); } },
  ...
  function build(jsPDF, opts) {
    ...
    var bottomReserve = 22; // page subtotal + cumulative rows + per-page signature footer
